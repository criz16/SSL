...
# set repo
wget -O /etc/apt/sources.list "https://raw.githubusercontent.com/criz16/SSL/master/sources.list.debian8"
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/criz16/SSL/master/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by xD'Criz</pre>" > /home/vps/public_html/index.html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/criz16/SSL/master/vps.conf"
service nginx restart

# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/criz16/SSL/master/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/criz16/SSL/master/1194.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
iptables -t nat -I POSTROUTING -s 192.168.100.0/24 -o eth0 -j MASQUERADE
iptables-save > /etc/iptables_criz.conf
wget -O /etc/network/if-up.d/iptables "https://raw.githubusercontent.com/criz16/SSL/master/iptables"
chmod +x /etc/network/if-up.d/iptables
service openvpn restart

# konfigurasi openvpn
cd /etc/openvpn/
wget -O /etc/openvpn/client.ovpn "https://raw.githubusercontent.com/criz16/SSL/master/client-1194.conf"
sed -i $MYIP2 /etc/openvpn/client.ovpn;
cp client.ovpn /home/vps/public_html/

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/criz16/SSL/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/criz16/SSL/master/badvpn-udpgw64"
fi
...
wget https://raw.githubusercontent.com/criz16/SSL/master/ddos-deflate-master.zip 
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/criz16/SSL/master/issue.net"
...
wget -O speedtest "https://raw.githubusercontent.com/criz16/SSL/master/speedtest_cli.py"
...
echo "Modified by Criz Romero"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
